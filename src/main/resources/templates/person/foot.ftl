			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-foot">
						...
						<div class="goods">
							<div class="goods-date" data-date="2015-11-21">
								<s class="line"></s>
							</div>
                            ...
                            <div class="goods">
                                ...
                                <div class="goods-box">
                                    <div class="goods-pic">
                                        ...
                                        <a class="goods-delete" href="/del?gsid=${goods.gsid}"><i class="am-icon-trash"></i></a>
                                        <div class="goods-status goods-status-show"><span class="desc"></span></div>
                                    </div>

                                    <div class="goods-attr">
                                        <div class="good-title">
                                            <a class="title" href="#" target="_blank">${goods.goodsname}</a>
                                        </div>
                                        <div class="goods-price">
										<span class="g_price">
                                        <span>¥</span><strong>${goods.goodsMoney}</strong>
										</span>
                                            <span class="g_price g_price-original">
                                        <span>¥</span><strong>142</strong>
										</span>
                                        ...
                                        <div class="goods-num">
                                            <div class="match-recom">
                                                <a href="/similar?goodsname=${goods.goodsname}" class="match-recom-item">找相似</a>
                                                <i><em></em><span></span></i>
                                            </div>
                                        </div>
                                    </div>
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="foot.ftl">足迹</a></li>
							<li> <a href="comment.html">评价</a></li>
							<li> <a href="/selectnews">消息</a></li>
						</ul>
					</li>
