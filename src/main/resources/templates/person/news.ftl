						...
						<div class="am-tabs am-tabs-d2" data-am-tabs>
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade" id="tab2">
									...
									<#list news as indents>
										<div class="s-msg-item s-msg-temp i-msg-downup">
                                            <h6 class="s-msg-bar"><span class="s-name">
												<#if indents.indentStatus == "0">
                                                    订单已签收
												<#elseif indents.indentStatus == "1">
                                                    订单派送中......
												<#elseif indents.indentStatus == "2">
                                                    正在等待揽收......
												<#else>
													订单处理中......
												</#if>
                                                ...
                                                <div class="i-msg-downup-con">
                                                    <a class="i-markRead" target="_blank" href="logistics.html">
                                                        <div class="m-item">
                                                            ...
                                                            <div class="item-info">
                                                                您购买的是:${indents.goodsname}<br>
                                                                快递单号:${indents.indentNumber}
                                                            </div>
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li> <a href="/zuji">足迹</a></li>
							<li> <a href="comment.html">评价</a></li>
							<li class="active"> <a href="news.ftl">消息</a></li>
						</ul>
					</li>
